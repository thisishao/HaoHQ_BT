<?php session_start();
	...
	if (isset($_POST['sub-log'])) {
		...
		if ($check == 1) {
			$pwdd = md5($_POST['pwd']);
			$sql = "SELECT * FROM `user` WHERE `email` = '".$_POST['email']."' AND `pass` = '".$pwdd."'";
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						<h1 style="color: red;">Login to your account</h1>
						<h3 style="color: red;"><?php echo $dangnhap;?></h3>
						<form action="" method="POST">
							<input type="email" placeholder="Email Address" name="email" />
							<span style="color: red;"><?php echo $error_email ?></span>
							<input type="password" placeholder="Password" name="pwd">
							<span style="color:red;"><?php echo $error_pwd ?></span>
							<button type="submit" class="btn btn-default" name="sub-log">Login</button>
							<span>Bạn không có tài khoản vui lòng <a href="register.php">Click</a> vào đây để đăng ký</span>
						</form>
					</div><!--/login form-->
				</div>
			</div>
